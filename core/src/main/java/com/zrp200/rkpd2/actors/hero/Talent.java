...
public enum Talent {
	...
	// RK Champion T3
	RK_FIRE(192, 3), RK_PROJECT(193, 3), RK_CHAMP_3(194, 3),
	...
	public static void initSubclassTalents( HeroSubClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents ){
		...
		switch (cls){
			...
			case RK_CHAMPION:
				Collections.addAll(tierTalents, RK_FIRE, RK_PROJECT, RK_CHAMP_3, RK_CHAMP_4, RK_CHAMP_5, RK_CHAMP_6, RK_CHAMP_7, RK_CHAMP_8); break;
		}
		for (Talent talent : tierTalents){
			talents.get(2).put(talent, 0);
		}
