...
public enum Talent {
	...
	RK_GIANT(195, 3), RK_CHAMP_5(196, 3), RK_CHAMP_6(197, 3),
	...
	public static void initSubclassTalents( HeroSubClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents ){
		...
		switch (cls){
			...
			case RK_CHAMPION:
				Collections.addAll(tierTalents, RK_FIRE, RK_PROJECT, RK_ANTIMAGIC, RK_GIANT, RK_CHAMP_5, RK_CHAMP_6, RK_CHAMP_7, RK_CHAMP_8); break;
		}
		for (Talent talent : tierTalents){
			talents.get(2).put(talent, 0);
		}
